...
--
-- This schema is intentionally kept independent from a specific deployment.
-- It can be applied to a PostgreSQL/Supabase project and evolved through migrations.
...
--
-- auth_user_id maps to Supabase Auth once the application is connected.
-- A participant does not need a row here.
-- ============================================================
...
--
-- Operators and managers can be assigned to one or more points.
-- Organizers are handled at organization level.
-- ============================================================
...
-- CONSENTS
--
-- Keep consent records immutable from the application perspective.
-- ============================================================
...
-- QR TOKENS
--
-- Store only a cryptographic hash of the token. The raw token is delivered
-- to the participant and is never required to be persisted in plaintext.
-- ============================================================
...
-- ============================================================
-- INITIAL RLS FOUNDATION
-- ============================================================
-- RLS will be enabled and policies added as authentication and roles are
-- connected. Keeping the policy work in a dedicated migration avoids making
-- assumptions about auth.uid() before Supabase is connected.
